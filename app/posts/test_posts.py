...
add_data = """{
  "data": {
    ...
    {"body": "How to build CRUD app with Python, Flask, SQLAlchemy and MySQL. Som reand456989@#$%^%> <html/>", "author": "test string", "published": "true", "creation_date": "2015-12-22T03:12:58.019077+00:00", "tittle": "test string"}
         ,
...
update_data = """{
  "data": {
    "attributes":
        ...
        {"body": "How to build CRUD app with Python, Flask, SQLAlchemy and MySQL. Som reand456989@#$%^%> <html/>", "author": "test string", "published": "false", "creation_date": "2015-12-22T03:12:58.019077+00:00", "tittle": "test string"},
    "type": "posts"
  }
