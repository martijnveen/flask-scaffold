...
add_data = """{
  "data": {
    ...
    {"url": "How to build CRUD app with Python, Flask, SQLAlchemy and MySQL. Som reand456989@#$%^%> <html/>", "description": "test string", "creation_date": "2015-12-22T03:12:58.019077+00:00"}
         ,
...
class TestVideos(unittest.TestCase):
    ...
    def test_01_add(self):
        ...
        rv = self.app.post('/api/v1/videos.json', data=add_data,
    ...
    def test_02_read_update(self):
        ...
        id = dict['data'][0]['id']
        rv = self.app.patch('/api/v1/videos/{}.json'.format(id),
    ...
    def test_03_delete(self):
        ...
        dict = json.loads(request.data.decode('utf-8'))
        id = dict['data'][0]['id']
        rv = self.app.delete('/api/v1/videos/{}.json'.format(id))
