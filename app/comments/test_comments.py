...
add_data = """{
  "data": {
    ...
    {"author_url": "http://techarena51.com", "body": "How to build CRUD app with Python, Flask, SQLAlchemy and MySQL. Som reand456989@#$%^%> <html/>", "author": "test string", "approved": "true", "created_on": "2015-12-22T03:12:58.019077+00:00"}
         ,
...
update_data = """{
  "data": {
    "attributes":
        ...
        {"author_url": "http://techarena51.com", "body": "How to build CRUD app with Python, Flask, SQLAlchemy and MySQL. Som reand456989@#$%^%> <html/>", "author": "test string", "approved": "false", "created_on": "2015-12-22T03:12:58.019077+00:00"},
    "type": "comments"
  }
